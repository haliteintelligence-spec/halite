  ...
  return (
    <div className="space-y-4">
      ...
      <InsightCard title="Consumer Sentiment Drivers" subtitle="What matters most in purchase decisions">
        ...
        <div className="mt-3">
          <AIBadge>
            73% of your consumers prefer clean formulas. Cross-referencing your catalogue:
            41 of 68 products meet clean beauty criteria — a 60% alignment rate with a clear
            gap in SPF and treatment categories.
          </AIBadge>
        </div>
      </InsightCard>
        ...
        <div className="space-y-2">
          {emerging.map(e => (
            ...
            >
              ...
              <span
                className="text-[10px] font-semibold uppercase tracking-wide px-2.5 py-1 rounded-full flex-shrink-0"
                style={{
