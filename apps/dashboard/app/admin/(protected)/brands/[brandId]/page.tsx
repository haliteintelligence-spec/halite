  ...
  return (
    <div className="max-w-3xl">
      ...
      <div className="rounded-xl mt-4 overflow-hidden" style={{ background: 'var(--surface)', border: '1px solid var(--border)' }}>
        ...
        >
          <div>
            <h2 className="text-[11px] font-semibold tracking-wide uppercase text-left" style={{ color: 'var(--ink-3)' }}>White Label</h2>
            <p className="text-[11px] mt-0.5 text-left" style={{ color: 'var(--ink-3)' }}>Apply the brand's own visual identity to the Halite platform.</p>
          </div>
        ...
        {wlOpen && (
          <div className="px-5 pb-5" style={{ borderTop: '1px solid var(--border)' }}>
            <div className="flex items-center justify-between mt-4 mb-4">
              <p className="text-[12px]" style={{ color: 'var(--ink-3)' }}>Enable white-label theming for this brand</p>
              <button
