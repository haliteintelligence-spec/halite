  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative max-w-7xl mx-auto px-6 pt-20 md:pt-20 pb-6 grid grid-cols-1 lg:grid-cols-[1.32fr_0.68fr] gap-12 items-center w-full">
          <div>
      ...
      <section className="py-6 md:py-[2.25rem] px-6" style={{ background: '#F2EBE0', borderTop: '1px solid #E8DDD0' }}>
      ...
      {/* ── WHAT YOU DO ──────────────────────────────────────────────────── */}
      <section id="what" className="py-6 md:py-[2.25rem] px-6 scroll-mt-16" style={{ background: '#FAF6F0' }}>
      ...
      {/* ── CATEGORIES & SCOPE ───────────────────────────────────────────── */}
      <section className="py-6 md:py-[2.25rem] px-6" style={{ background: '#F2EBE0' }}>
        <div className="max-w-7xl mx-auto">
      ...
      {/* ── POINTS & REWARDS ─────────────────────────────────────────────── */}
      <section id="rewards" className="py-6 md:py-[2.25rem] px-6 scroll-mt-16" style={{ background: '#450F2A' }}>
      ...
      {/* ── PRIVACY + APP CTA ────────────────────────────────────────────── */}
      <section className="py-6 md:py-[2.25rem] px-6" style={{ background: '#2D0A1C' }}>
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
          <div>
            <p className="text-[11px] font-semibold tracking-[0.22em] uppercase mb-4" style={{ color: 'rgba(193,122,71,0.9)' }}>
      ...
      <section className="py-[1.3125rem] md:py-6 px-6" style={{ background: '#F2EBE0', borderTop: '1px solid #E8DDD0' }}>
