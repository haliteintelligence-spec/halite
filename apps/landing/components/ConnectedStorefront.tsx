...
export function HeroProductCards() {
  return (
    ...
    <div className="relative mx-auto w-full max-w-[300px] sm:max-w-none">
      ...
      {/* The tags break the frame's corners, so they only make sense once the
          frame has room around it. */}
      <div className="hidden sm:block absolute -top-6 -right-5 rounded-2xl px-5 py-3.5 shadow-xl" style={{ background: '#C17A47' }}>
